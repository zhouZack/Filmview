...
- (void)handlePan:(UIPanGestureRecognizer*)rec{
    ...
    if (((self.mainVC.view.left <= 0) && (_scalef <= 0)) || ((self.mainVC.view.left >= (kScreenWidth - kMainPageDistance )) && (_scalef >= 0)))
    {
        //边界值管控
        _scalef = 0;
        needMoveWithTap = NO;
...
//        NSLog(@"%f",leftTabCenterX);
    ...
    else
    {
        ...
        else if (self.mainVC.view.left > (kScreenWidth - kMainPageDistance))
        {
            [self openLeftView];
            _scalef = 0;
        }
